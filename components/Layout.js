    ...
    <main>
      ...
      <style jsx global>{`
        ...
        *:after {
        ...
        .title {
          font-family: 'M PLUS Rounded 1c', 'Roboto', 'Segoe UI', Helvetica, Arial, sans-serif;
          font-weight: bold;
        }
        ...
        .type--inverted {
         ...
         @media (max-width: 768px) {
           ...
           section {
             padding: var(--theme-scale-section-m) var(--theme-scale-section-m) var(--theme-scale-section-s);
           }
         }
         ...
         @media (min-width: 768px) {
           ...
           section {
             padding: var(--theme-scale-section-l) var(--theme-scale-section-l) var(--theme-scale-section-s);
           }
         }
      `}</style>
    </main>
